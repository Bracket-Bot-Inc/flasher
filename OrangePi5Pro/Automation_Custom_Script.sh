...
runasuser "[[ -d BracketBotOS ]] || git clone https://github.com/Bracket-Bot-Inc/BracketBotOS.git"
runasuser "[[ -d BracketBotAI ]] || git clone https://github.com/Bracket-Bot-Inc/BracketBotAI.git"
runasuser "[[ -d BracketBotApps ]] || { git clone https://github.com/Bracket-Bot-Inc/BracketBotApps.git && printf 'dashboard\nhey_bracketbot\n' > BracketBotApps/.autostart && printf 'OPENAI_API_KEY=' > BracketBotApps/.env; }"
